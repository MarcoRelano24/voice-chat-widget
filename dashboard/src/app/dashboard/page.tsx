  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-8">
        <div>
          <h1 className="text-3xl font-bold text-gray-900">All Widgets</h1>
          <p className="text-gray-600 mt-1">Create and manage voice chat widgets</p>
        </div>
      ...
      {widgets.length === 0 ? (
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-12 text-center">
          ...
          <p className="text-gray-600 mb-6">Create your first voice chat widget to get started</p>
          <Link
            href="/dashboard/widgets/new"
